...
public class Tool {
    ...
    public static int concatenateDateFormat(int first, int second, int third) {
        ...
        if(third < 10) {
            string3 ="0".concat(Integer.toString(third));
        } else {
            string3 = Integer.toString(third);
        }
        String concatenated = string1.concat(string2).concat(string3);
